            ...
            <div class="header-body">
                <div class="d-flex p-4">
                    <div class="col-lg-6 col-7  ">
                        <a href="{{ route('user.create') }}" class="btn btn-neutral bg-primary text-white">+ AÑADIR USUARIO</a>
                    </div>
                    <div class="col-lg-6 col-5 text-right ">

                        <form action="#" method="GET">
                            <div class="container d-flex">
                                <input name="busqueda" class="form-control" placeholder="Buscar Usuario" type="text" value="">
