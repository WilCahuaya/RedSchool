            ...
            <div class="header-body">
                <div class="d-flex p-4">
                    <div class="col-lg-6 col-7  ">
                        <a href="{{ route('matriculas.create') }}" class="btn btn-neutral bg-primary text-white">+ AÑADIR
                            MATRÍCULA</a>
                    </div>
                    <div class="col-lg-6 col-5 text-right ">
                        ...
                        <form action="#" method="GET">
                            <div class="container d-flex">
                                <input name="busqueda" class="form-control" placeholder="Buscar Matrícula" type="text"
                                    value="">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody class="list">
                                        ...
                                        <tr>
                                            <td>
                                                @foreach ($students as $student)
                                                    @if ($student->id == $matriculas->students_id)
                                            ...
                                            <td>
                                                @foreach ($courses as $course)
                                                    @if ($course->id == $matriculas->courses_id)
                                                        {{ $course->name }}
                                            </td>
                                            <td>
                                ...
                                <td>
                                    <a href="{{ route('matriculas.edit', $matriculas->id) }}"
                                ...
                                <td>
                                    <form action="{{ route('matriculas.destroy', $matriculas->id) }}" method="POST">
                                        ...
                                        <button type="submit" onclick="return confirm('Seguro que desea dar de baja')"
