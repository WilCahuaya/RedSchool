    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('importtutor') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">

                        <div class="clo-md-6">
                            <input type="file" name="documentotutors">
                        </div>
                ...
                <div class="d-flex p-4">
                    <div class="col-lg-6 col-7  ">
                        <button type="button" class="btn btn-neutral bg-primary text-white" data-toggle="modal"
                            data-target="#exampleModalCenter">+ AÑADIR PADRE</button>
                    </div>
                    <div class="col-lg-6 col-5 text-right ">

                        <form action="{{ route('tutor') }}" method="GET">
                            <div class="container d-flex">
                                <input name="busqueda" class="form-control" placeholder="Buscar Padre" type="text" value="{{$busqueda}}">
                        ...
                        @else
                                @foreach ($tutors as $tutor)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="/tutor/{{ $tutor->id }}/condition" method="POST">
                                                @csrf
                                                @method('put')
